...
export function Home({ onPlay }: HomeProps) {
  return (
    ...
    >
      <div className="relative z-10 mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center px-6 py-10">
        <Dixi
          pose="wave"
          size="2xl"
          className="drop-shadow-[0_12px_18px_rgba(30,31,63,0.25)]"
        />

        <h1 className="mt-2 select-none text-center text-6xl font-black leading-none tracking-tight text-navy drop-shadow-[0_4px_0_rgba(255,255,255,0.75)] sm:text-8xl lg:text-9xl">
          aprendi<span className="text-green">x</span>
        </h1>

        <div className="mt-5 text-center">
          <p className="text-3xl font-extrabold leading-tight text-navy drop-shadow-[0_2px_0_rgba(255,255,255,0.7)] sm:text-4xl">
            Olá, Explorador!
          </p>
